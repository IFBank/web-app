...
const PedidoCardDashBoard: React.FC<PedidoCardDashBoardProps> = ({ isEven=false, hasBorderRTop=true, hasBorderRBottom=false, ... rest }) => {
	
	const [showItems, setShowItems] = useState<boolean>(false);

	return (
		<Container bgColor={ isEven ? "primary": "secondary" } 
		...
		> 
			...
			<MaterialIconStyled name={showItems ? "expand_less" : "expand_more"} color="white" size={20} />
		</Container> 
	);
